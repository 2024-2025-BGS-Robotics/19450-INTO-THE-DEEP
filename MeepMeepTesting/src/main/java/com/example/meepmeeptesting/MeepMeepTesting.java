...
public class MeepMeepTesting {
    ...
    private static RoadRunnerBotEntity RightSideBlueBot;
    private static RoadRunnerBotEntity LeftSideBlueBot;
    private static RoadRunnerBotEntity RightSideRedBot;
    private static RoadRunnerBotEntity LeftSideRedBot;
    ...
    public static void main(String[] args) {
        MeepMeep meepMeep = new MeepMeep(900);
            ...
            System.out.println("Init");
             ...
             RightSideBlueBot = new DefaultBotBuilder(meepMeep)
             ...
             LeftSideBlueBot = new DefaultBotBuilder(meepMeep)
